package com.x.print.user;

import com.x.print.domain.model.user.User;
import com.x.print.ui.screen.user.UserBrowse;
import com.x.print.ui.screen.user.UserEdit;
import com.x.print.test_support.UiIntegrationTest;
