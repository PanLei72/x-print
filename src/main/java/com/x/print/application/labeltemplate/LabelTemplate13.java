...
public class LabelTemplate13 extends LabelPrintable {


    private static final Logger logger = LogManager.getLogger(LabelTemplate13.class);
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        try {
            ...
            graphics2D.drawLine((int) x, (int) (y + _lineHeight * 16), (int) x + _lableWidth, (int) (y + _lineHeight * 16));
            graphics2D.drawLine((int) x, (int) (y + _lineHeight * 22), (int) x + _lableWidth, (int) (y + _lineHeight * 22));
            ...
            graphics2D.drawLine((int) x + _titileWidth + _contextWidht, (int) (y + _lineHeight * 9), (int) x + _titileWidth + _contextWidht, (int) (y + _lineHeight * 10));
            ...
            graphics2D.drawLine((int) x + _titileWidth * 2 + _contextWidht, (int) (y + _lineHeight * 9), (int) x + _titileWidth * 2 + _contextWidht, (int) (y + _lineHeight * 10));
            ...
            graphics2D.drawString(this.getLabelDefinitionDataValue("name10"), (int) x + _leftwhite + _titileWidth + _contextWidht, (int) (y + _lineHeight) + _offerY);
            graphics2D.drawString(this.getLabelDefinitionDataValue("name11"), (int) x + _leftwhite + _titileWidth + _contextWidht, (int) (y + _lineHeight * 2) + _offerY);
            ...
            graphics2D.drawString(this.getLabelDefinitionDataValue("name13"), (int) x + _leftwhite + _titileWidth + _contextWidht, (int) (y + _lineHeight * 5) + _offerY);
            graphics2D.drawString(this.getLabelDefinitionDataValue("name14"), (int) x + _leftwhite + _titileWidth + _contextWidht, (int) (y + _lineHeight * 6) + _offerY);
            graphics2D.drawString(this.getLabelDefinitionDataValue("name15"), (int) x + _leftwhite + _titileWidth + _contextWidht, (int) (y + _lineHeight * 9) + _offerY);
            graphics2D.drawString(this.getLabelDefinitionDataValue("name16"), (int) x + _leftwhite, (int) (y + _lineHeight * 16) + _offerY);
            ...
            graphics2D.drawString(value13, (int) x + _leftwhite + _titileWidth, (int) (y + _lineHeight * 6) + _offerY);
            graphics2D.drawString(value14, (int) x + _leftwhite + _titileWidth * 2 + _contextWidht, (int) (y + _lineHeight * 6) + _offerY);

            BufferedImage _barcode = Barcode4jUtility.generateBarcode(barcode, true, OutputStream.nullOutputStream());

            graphics2D.drawImage(_barcode, (int) x + _leftwhite + _titileWidth, (int) (y + _lineHeight * 10 + 5), null);
            graphics2D.drawString(barcode, (int) x + _leftwhite + _titileWidth + 20, (int) (y + _lineHeight * 12 + 15) + _offerY);

            font = new Font("黑体", Font.BOLD, 13);
            graphics2D.setFont(font);
            graphics2D.drawString(value8, (int) x + _leftwhite + _titileWidth * 2 + _contextWidht, (int) (y + _lineHeight) + _offerY);
            graphics2D.drawString(value10, (int) x + _leftwhite + _titileWidth * 2 + _contextWidht, (int) (y + _lineHeight * 4) + _offerY);
            graphics2D.drawString(value12, (int) x + _leftwhite + _titileWidth * 2 + _contextWidht, (int) (y + _lineHeight * 9) + _offerY);
            ...
            graphics2D.drawString(value11, (int) x + _leftwhite + _titileWidth * 2 + _contextWidht, (int) (y + _lineHeight * 5) + _offerY);


            font = new Font("黑体", Font.BOLD, 7);
            graphics2D.setFont(font);

            graphics2D.drawString(value9, (int) x + _leftwhite + _titileWidth * 2 + _contextWidht, (int) (y + _lineHeight * 2) + _offerY);


            graphics2D.drawString(barcode, (int) x + _leftwhite + _titileWidth + 15, (int) (y + _lineHeight * 16) + _offerY);
            BufferedImage _sfcBarcode = Barcode4jUtility.generateBarcode(barcode, true, OutputStream.nullOutputStream());

            graphics2D.drawImage(_sfcBarcode, (int) x + _leftwhite + _titileWidth, (int) (y + _lineHeight * 18 + 15), null);
